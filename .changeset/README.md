...
This folder is used by [Changesets](https://github.com/changesets/changesets) to track unreleased changes destined for the next published version of the design-system packages (currently `@huchu/react`, with more to follow).
