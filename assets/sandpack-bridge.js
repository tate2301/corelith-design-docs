 ...
 * esm.sh. The sandbox iframe loads @corelithzw/react from esm.sh too;
...
(function () {
  ...
  function buildBridgeModule() {
    return [
      ...
      "// This list mirrors packages/react/src/index.ts — keep in sync",
      "// whenever the package surface grows (run `npm run api-report`",
      "// in packages/react to see the canonical export list).",
      "export const {",
      "  Alert, AlertDialog, AppShell, AuthShell, Avatar,",
      "  Badge, BottomSheet, BottomTabs, Button,",
      "  Calendar, Card, Chart, Checkbox, Checklist, Combobox,",
      "  CommandPalette, CommentsThread,",
      "  DataTable, DataToolbar, DatePicker, DayList, DEFAULT_REACTIONS,",
      "  Dialog, Drawer, DropdownMenu,",
      "  EmptyState, Field, FileUpload, FilterChips, Form,",
      "  Grabber, I18nProvider, InlineEdit, Input, InputOtp,",
      "  KanbanBoard, Kbd, KpiGrid,",
      "  Lightbox, LocalePicker,",
      "  Menu, Meter, MobileShell, Modal,",
      "  NavGroup, NavItem, NotificationMatrix,",
      "  PageHeader, Pagination, Popover, Progress,",
      "  Radio, RadioGroup, RoleSwitcher, RowCard,",
      "  SaveBar, SegmentedControl, Select, Skeleton, Spinner,",
      "  Stack, Stat, StatCard, StatHero, Stepper, Switch,",
      "  Tab, Tabs, TextArea, Toast, ToastProvider, Tooltip,",
      "  useComments, useDateRange, useFieldContext, useGallery,",
      "  useI18n, useInterval, useKanban, useMatchMedia, useMediaQuery,",
      "  useOptimistic, usePersistedFlag, usePreferences,",
      "  useT, useToast, useUpload, useUrlState,",
      "} = resolved;",
      "",
      "export const {",
