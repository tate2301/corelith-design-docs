...
(function () {
  ...
  const SIDEBAR = [
    ...
    { label: 'Reference', items: [
      ...
      ['Primitive ·  Table',             ROOT + 'system/p-table.html',       'p-table',      'New'],
      ['Primitive ·  Tabs',              ROOT + 'system/p-tabs.html',        'p-tabs',       'New'],
      ['Primitive ·  Tag',               ROOT + 'system/p-tag.html',         'p-tag',        'New'],
      ['Primitive ·  Toast',             ROOT + 'system/p-toast.html',       'p-toast',      'New'],
      ['Primitive ·  Skeleton',          ROOT + 'system/p-skeleton.html',    'p-skeleton',   'New'],
      ['Primitive ·  Pagination',        ROOT + 'system/p-pagination.html',  'p-pagination', 'New'],
      // ── Blocks ──────────────────────────────────────────────
      ...
      ['Pattern ·  Detail tabs',         ROOT + 'system/x-detail-tabs.html', 'x-detail-tabs', 'New'],
      ['Pattern ·  Master data',         ROOT + 'system/x-master-data.html', 'x-master-data', 'New'],
      ['Pattern ·  Bulk edit',           ROOT + 'system/x-bulk-edit.html',   'x-bulk-edit',   'New'],
      ['Pattern ·  Import wizard',       ROOT + 'system/x-import-wizard.html','x-import-wizard','New'],
      ['Pattern ·  Audit view',          ROOT + 'system/x-audit-view.html',  'x-audit-view',  'New'],
      ['Pattern ·  Approval flow',       ROOT + 'system/x-approval-flow.html','x-approval-flow','New'],
      ['Pattern ·  Role gate',           ROOT + 'system/x-role-gate.html',   'x-role-gate',   'New'],
      ['Pattern ·  Executive dashboard', ROOT + 'system/x-executive-dashboard.html','x-executive-dashboard','New'],
      ['Pattern ·  Settings',            ROOT + 'system/x-settings.html',    'x-settings',    'New'],
      ['Pattern ·  Onboarding',          ROOT + 'system/x-onboarding.html',  'x-onboarding',  'New'],
      ['Pattern ·  Notifications',       ROOT + 'system/x-notifications.html','x-notifications','New'],
      ['Pattern ·  Help center',         ROOT + 'system/x-help-center.html', 'x-help-center', 'New'],
      ['Pattern ·  Offline runtime',     ROOT + 'system/x-offline-runtime.html','x-offline-runtime','New'],
